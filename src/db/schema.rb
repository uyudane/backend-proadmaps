...
ActiveRecord::Schema[7.0].define(version: 20_221_112_120_410) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.index %w[user_id roadmap_id], name: 'index_likes_on_user_id_and_roadmap_id', unique: true
  ...
  create_table 'roadmap_tags', force: :cascade do |t|
    ...
    t.index %w[tag_id roadmap_id], name: 'index_roadmap_tags_on_tag_id_and_roadmap_id', unique: true
